...
export const Seo = ({
  ...
  const autoOg = (() => {
    ...
    if (typeof window === 'undefined') return 'https://dental-website-frontend.vercel.app/Logo%20Lightmode.png';
    ...
    return `${base}/og/image?title=${encodeURIComponent(titleParam)}&subtitle=${encodeURIComponent(description || '')}&theme=${encodeURIComponent(theme)}&image=${encodeURIComponent('https://dental-website-frontend.vercel.app/Logo%20Lightmode.png')}`;
  })();
  const hrefLangs = (() => {
